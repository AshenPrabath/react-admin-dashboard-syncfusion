...
const TrackingInfoModal = ({ currentOrder }) => {
    const { setTrackingInfoDialogVisible, currentColor } = useStateContext();

    const order = ordersData.find((obj) => obj.OrderID === currentOrder);
    console.log(currentOrder);

    const dialogClose = () => {
        setTrackingInfoDialogVisible(false);
                ...
                <div className=" p-10 w-8/12 h-[90vh] bg-white rounded-lg dark:text-gray-200 dark:bg-secondary-dark-bg">
                    <div className=" h-full pb-20 ">
                        <div className="flex justify-between border-b-2 ">
                            <p className="text-3xl font-bold pb-2 ">Tracking #{order.tracking.trackingID}</p>
