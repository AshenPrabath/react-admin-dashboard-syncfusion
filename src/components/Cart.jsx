...
const Cart = () => {
  ...
  return (
    <div className='bg-half-transparent w-screen h-screen fixed nav-item top-0 right-0 md:overflow-hidden overflow-auto md:hover:overflow-auto'>
      <div className='float-right h-screen dark:text-gray-200 bg-white dark:[#484B52] w-400 overflow-y-scroll dark:bg-secondary-dark-bg'>
        ...
        <div className='flex-col border-t-1 border-color p-4 ml-4'>
              ...
              {cartData.map((item, index) => (
                <div key={index} className='flex  p-3 border-b-1 '>
                  ...
                  <div className='w-full'>
                    <h2 className='font-bold text-md hover:cursor-pointer hover:underline'>{item.name}</h2>
                    <p className='text-xs text-gray-600  dark:text-gray-400 font-semibold'>{item.category}</p>
          ...
          <div className='flex justify-between mt-3'>
            <p className='font-base text-lg text-gray-500 dark:text-gray-400'>Sub Total </p>
            <p className='font-semibold text-lg'>${totalPrice} </p>
          </div>
          <div className='flex justify-between mt-2'>
            <p className='font-base text-lg text-gray-500 dark:text-gray-400'>Total </p>
            <p className='font-semibold text-lg'>${totalPrice} </p>
          </div>
